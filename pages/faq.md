...
_**Q: How can I enable the Virtualization in order to turn vagrant on?**_
First of all, you have to access the BIOS. To do that, you need to reboot your computer and press the appropriate key while it’s booting. It is usually the "F2" or "Esc" or "Delete" key. Once you have entered the BIOS setup menu, you have to search for an option called "Intel VT-x", "Intel Virtualization Technology" or something similar. Enable this option, save and reset. Now the "vagrant up" command should be working fine.

_**Q: Why is the "Submit" button not showing up when I try to submit my survey?**_
...
_**Q: Why does Firefox say “Unable to connect” when I try to load my community?**_
...
_**Q: When I first run BeLL with the `vagrant up` command the download fails, why?**_
...
_**Q: I named my repo incorrectly by not naming it &lt;username&gt;.github.io, can I rename it or I need to delete it?**_
...
_**Q: What do I do if I already have a github.io with my username?**_
...
_**Q: What do I do if I am on Unix/Mac/Linux and accidentally give root permissions, corrupting the installation of the vagrant vm?**_
In ```git bash``` type: 
```
cd ole--vagrant-vi
vagrant destroy -f
