...
**NOTE**: Try to add and experiment with as many markdown elements as you can and make your page attractive. Remember to include some pictures or charts, and it will make your page looks fascinating. A list of sample profile pages can be found [**here**](https://github.com/open-learning-exchange/open-learning-exchange.github.io/tree/master/pages/profiles). Be creative.  
