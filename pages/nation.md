...
> On the nation side ([vi.ole.org](http://vi.ole.org:5985/apps/_design/bell/MyApp/index.html)), you can log in as admin/password and check that the sync worked. Click on "Manager" once again.
