...
Note: Refer to the Prerequisites section of [Vagrant instructions](http://open-learning-exchange.github.io/#!pages/vi/vi-vagrant.md) if you encountered an error while executing the command `vagrant up`
