...
On a laptop open a web browser and type [http://tplinklogin.net](http://tplinklogin.net)(Applies to TPLink routers only) or the default address of the router you are using, in this case [http://192.168.0.1](http://192.168.0.1) in the above example). 
