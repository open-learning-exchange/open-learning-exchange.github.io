...
Below are two images of the RPi with and without a case. On the right is an image of an RPi in a case and on the left is an image of RPI without a case.
...
![USB A > C Cable](images/tg-quickstart-cable-usb.png) ![RJ45 Cable](images/tg-quickstart-cable-rj45.png)
