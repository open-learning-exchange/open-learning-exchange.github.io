...
The project got abandoned since, but the entire history is still available at [Bug Hunt](http://open-learning-exchange.github.io/#!pages/bughunt.md).
...
Since this is the current state of the project, it is extremely important that you read carefully the documentation at [Automated Testing with Python](http://open-learning-exchange.github.io/#!pages/automatedtestingpython.md). That will introduce you to the motivation behind testing, and explain you how to setup a testing environment on your computer.
...
To get started, you can find the documentation at [Automated Testing with CodeceptJS](http://open-learning-exchange.github.io/#!pages/automatedtestingcodeceptjs.md). Good luck!
