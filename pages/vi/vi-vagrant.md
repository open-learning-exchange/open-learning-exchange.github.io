...
**NOTE**: If the command `vagrant up` is not working, try installing [Virtual Box version 5.1](https://www.virtualbox.org/wiki/Download_Old_Builds_5_1). Also make sure to have Hyper-V enabled in your Windows features if you are still having trouble.
