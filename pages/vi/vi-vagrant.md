...
- We have a Vagrant virtual machine called `dev` running in VirtualBox.
...
[Instructions to install Vagrant - README.md](#!pages/vi/vi-planet-installation-vagrant.md)
