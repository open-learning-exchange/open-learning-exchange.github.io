# Step 3.2 - Planet Configurations
**Estimated Time: 1.5h** 
...
- [Apache CouchDB](https://en.wikipedia.org/wiki/Apache_CouchDB) is a database software that we use for the Planet. You can see the back-end interface of our CouchDB at http://localhost:2300/_utils. In `_utils`, you have the opportunity to see all data of your Planet application.
