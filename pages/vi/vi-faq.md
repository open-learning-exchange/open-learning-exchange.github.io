...
+ You have a few options:
  ...
  1. Rename the original username.github.io repo to something else for now and then follow the [First Steps](vi-first-steps.md).
  ...
  4. Or you can just create another GitHub account, and use that for OLE work.
