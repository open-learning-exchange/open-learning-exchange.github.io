...
Follow the directions under the [Create Issues and Pull Requests tab](vi-create-issues-and-pull-requests.md). Create three more issues, add comments to three other issues, and resolve three issues by making the necessary changes in your repo with three separate pull requests.
