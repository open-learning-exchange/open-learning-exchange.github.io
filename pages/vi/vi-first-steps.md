...
**NOTE**: When you are fixing an issue, mention the number of the issue you are fixing in the title of your pull request and make a new branch for every new issue/commit.
