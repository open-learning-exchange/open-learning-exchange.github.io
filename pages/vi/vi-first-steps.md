...
For IDE/Editor, we recommend **[Sublime](https://www.sublimetext.com/), **[Visual Studio](https://code.visualstudio.com/), **[WebStorm](https://www.jetbrains.com/webstorm/?fromMenu). Sublime and Visual Studio are both light editors, but WebStorm has a lot of useful features. If you have a school email, you can use it to get a free license from **[jetbrains](https://www.jetbrains.com/).
