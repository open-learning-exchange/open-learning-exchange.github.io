...
* After resolving the issue in the branch, make a pull request to the open-learning-exhange repository [the upstream repository](https://github.com/open-learning-exchange/open-learning-exchange.github.io)
