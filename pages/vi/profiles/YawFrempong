...
## About Me
Hello, I am a undergraduate computer engineering student with an interest in computer science. I go to school in Charlotte, NC. I see this internship as an opportunity work with and learn from talented developers aswell as learn current industry software development practices.I have always loved teaching and I think give everyone an chance to get education in STEM fields is important. I look forward to working with everyone on the Open Learning Exchange development team to help  expanding open-access learning solutions.
