...
The MD wiki has plenty of resources to help you complete the steps. There is a list of useful links at the end of each step and we created a [FAQ page](in-faq.md) where you can find the answers to some commonly asked questions. This page has even more useful links and video tutorials that will help you become familiar with the tools/languages we use. For anything that is not in the FAQ page, Google and Stack Exchange are your friends :)

We also want you to keep us updated a relatively good amount in the Gitter chat as you complete these steps. Check our [Gitter chat](in-chat.md) page for more information about how to best communicate in Gitter.
...
Once you have finished installing, go to the [#!./pages/interns/configuration page](in-configurations.md) to set up your Community BeLL.

## Step 2 - Vagrant Tutorial

Review these [Vagrant instructions](in-vagrant.md) to ensure that you have fully completed the previous step. You should be familiar with this since you will need to use it during your internship.

## Step 3 - Markdown and Fork Tutorial

Follow the instructions on the [GitHub and Markdown page](in-githubandmarkdown.md). Make sure that you've linked to your github.io and your personal .md page on the [Gitter chat](https://gitter.im/open-learning-exchange/chat) (&lt;username&gt;.github.io and &lt;username&gt;.github.io/#!pages/profiles/&lt;username&gt;.md).
...
**NOTE**: You can track your progress with the number of pull requests and issues [here](in-track-progress.html).
...
Once you have been added to the team, read through the [intern orientation document](in-intern-orientation.md).