...
[My Dashboard Video](movies/in-mydashboard.mp4)

[Library](movies/in-library.mp4)

[Feedback](movies/in-feedback.mp4)

[Generating Activity Reports](movies/in-generatingactivityreports.mp4)
...
[Here is the first page of the PDF "Feelings"](pdf/in-feelings.pdf)
[Here is the song "Opposite Song"](music/in-oppositesong.mp3)
[Here is the video "Burka Avenger"](movies/in-burkaavenger.mp4)
...
![Burka Avenger Upload](images/in-add-new-resource.png)
...
![Update from the nation](images/in-update-publication.png "Dashboard in your localhost")
...
#### Return to [First Steps](in-firststeps.md#Step_4_-_BeLL-Apps_Tutorial)