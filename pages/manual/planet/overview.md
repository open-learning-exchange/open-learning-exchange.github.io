...
## Become a Member
To use **PLANET**, you need to be part of the system.  

 The first page you will see is the **Login page**.  
[Learn more about becoming part of PLANET and using it.](member.md)
...
(Planned features may include personalized dashboards where learners can track their courses, progress, and upcoming activities.)  
...
## Exams
**This portion is under development.**  
(Planned features may allow learners to take exams within the system, and educators to create and grade assessments digitally.)  
