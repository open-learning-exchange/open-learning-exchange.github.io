...
**TIP**: While commit message style varies from person to person, this [style guide](http://udacity.github.io/git-styleguide/) created by Udacity is a good reference of how to write a clean, short and straightforward commit.
