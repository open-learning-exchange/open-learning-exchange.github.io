...
It is always recommended that you create a branch locally by following the steps above as it makes it easier to track changes and collabarate with others, however, you may also choose to create a branch in your remote repository by following the instructions [here](https://help.github.com/articles/creating-and-deleting-branches-within-your-repository/). This is usually done in order to fix small changes in your repository. If you created a remote branch and wish to work on it locally, you may use 'git checkout -b name_of_your_new_branch --track origin/name_of_your_new_branch' to switch to that branch on your local repository. Make sure your local repository is updated to the latest changes from your remote repository before doing that. You may use `git pull` to pull the latest changes.
