...
* Once you have finished step 8, sync your community with the nation (as you did in Step 7 - [Nation Planet tab](../vi/vi-nation.md)).
  ...
  Next thing is to add yourself to the virtual intern list found in [vi-team.md](../vi/vi-team.md) and create a pull request. Message us ("@.giddie" and "@dogi") in the Discord channel so that we can set up a meeting and add you to the team as soon as possible.
