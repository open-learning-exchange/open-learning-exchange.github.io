...
Head over to https://github.com/open-learning-exchange/open-learning-exchange.github.io and make sure you have the following done:

  * 5 Pull Requests (1 Pull Requests from Step 3, 1 Pull Requests from Step 6 and 3 Pull Requests from Step 8).
  * 4 Comments (1 comment at Step 6, 3 comment's at Step 8)
  * 4 Issues Created (1 issue at Step 6, 3 issues at Step 8)
