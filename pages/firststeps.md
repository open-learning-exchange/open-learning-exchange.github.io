...
Let us know in the Gitter chat when you're done and so that we can send the survey/publications to your community. Then, fill out the survey click the submit button, and lastly sync it to the nation (as outlined in step 7). 
